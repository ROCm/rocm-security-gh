...
at commit ``47947a1b1f93647eaf66963cc05ca2dfb1b65243``:
https://github.com/ROCm/TheRock/blob/47947a1b1f93647eaf66963cc05ca2dfb1b65243/build_tools/github_actions/github_actions_api.py

Only the handful of functions used by scanners in this repo are kept here;
TheRock's broader GitHub REST API client is intentionally omitted.
"""
...
class GithubActionsApi(NamedTuple):
    """The workflow-command helpers scanner drivers use via ``import_github_actions_api``."""
...
def import_github_actions_api() -> GithubActionsApi:
    """Return the vendored workflow-command helpers used by scanner drivers."""
